...
/**
 * AnalyticsLedger — the original cashier-style ledger view extracted from
 * src/app/admin/analytics/page.tsx so it can live next to the new
 * Dashboard tab without contaminating it.
 *
 * Functionally identical to the previous page implementation: lifetime +
 * range KPI accordions, employee + search filters, transaction table
 * (Issue / Redeem / Top Up / Ticket / Void), CSV export, and admin-only
 * void/cancel actions. The fetch only runs while this tab is mounted.
 */
...
// ─── helpers (verbatim from page.tsx) ───────────────────────────────────────
...
// ─── sub-components (verbatim from page.tsx) ───────────────────────────────
